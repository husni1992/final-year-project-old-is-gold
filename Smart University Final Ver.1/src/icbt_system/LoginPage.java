  ...
  MainWindow mnWin = new MainWindow();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // String s2 = jTextField2.getText();
        ...
        String sr = String.valueOf(jPasswordField1.getPassword());
        ...
        try {
            ...
            while (rs.next()) {  
                ...
                if((s1.equalsIgnoreCase(s)) && (sr.equals(p))){
                    k=1;
                    //uLevel = rs.getInt("userlevel");
                } else {
             ...
             if(k==1){
                    //JOptionPane.showMessageDialog(rootPane, "Login Succesfull. User level is: "+uLevel);
